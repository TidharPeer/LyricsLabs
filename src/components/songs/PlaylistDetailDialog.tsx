...
import { fetchPlaylistSongs, removeSongFromPlaylist, addSongToPlaylist, searchSongs, fetchSongs } from '@/lib/db'
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          {loading ? (
            ...
            <div className="divide-y">
              {songs.map(song => (
                <div key={song.id} className="flex items-center gap-3 px-5 py-3 hover:bg-accent/50 group/row">
